...
import { Address, Value } from "./helios.js";
import { ADA } from "./inputs.js";
import { Link } from "./Link.js";
import { formatMintingPolicyID, parseTokenName } from "./utils.js";
...
export function Overview(props) {
     ...
     function renderAssets(value) {
        ...
        for (const mph of value.assets.mintingPolicies) {
            ...
            for (const tokenName of tokenNames) {
                ...
                const tokenNameString = parseTokenName(tokenName);
                ...
                elems.push(html`
                    <p>
                        ...
                        <pre title="${mph.hex}">
                            <${Link}
                                href="https://preprod.cexplorer.io/policy/${mph.hex}"
    ...
    function renderPubKeyHash(pkh) {
        ...
        //return html`<pre title=${addr}><${Link} href="https://preprod.cexplorer.io/address/${addr}" text=${addr}/></pre>`;
