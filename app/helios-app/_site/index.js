...
import PreprodNetwork from "./network.js";
...
function App(props) {
    ...
    async function connect() {
        ...
        try {
            ...
            if (networkId == 1) {
                throw new Error("wallet not connected to preprod testnet");
            }
            ...
            if (refUtxo === null) {
                ...
                const network = await PreprodNetwork.new();

                setWaitMessage("Verifying connection to preprod testnet...");
            ...
            <div id="welcome-wrapper">
                <div id="welcome">
                    ...
                    <div class="content">
                        ...
                        <br/>
                        <p>Right now PicoSwap only works with the <${Link} href="https://chrome.google.com/webstore/detail/eternl/kmhcihpebfmpgmihbkipmjlmmioameka" text="Eternl"/> wallet, and only with the preprod testnet. We will expand this after the V2 parameter update.</p>
                        <br/>
