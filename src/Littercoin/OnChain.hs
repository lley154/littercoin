...
mkLCValidator params dat red ctx = 
    case red of
        MintLC qty -> checkAmountMint qty        
                  &&  checkLCDatumMint qty
                  &&  signedByAdmin  
        BurnLC qty -> checkAmountBurn qty      
                  &&  checkLCDatumBurn qty
                  &&  checkValueAmountBurn                 
                    
        AddAda qty -> checkLCDatumAdd qty
                 &&   checkValueAmountAdd 
      where        
